...
export type Workspace = {organization:string;sample_data:boolean;timezone:string;shifts:Shift[];volunteers:Volunteer[];invitations:Invitation[];activity:Activity[];agent_runs:Run[];bedrock_configured:boolean;hosted?:boolean};
